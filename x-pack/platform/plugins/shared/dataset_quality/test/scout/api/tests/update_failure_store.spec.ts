...
/**
 * Reads back the failure store options that Elasticsearch actually stored for the
 * data stream. The original FTR asserted on the raw Elasticsearch request envelope
 * echoed through the API response, which said nothing about the state the endpoint
 * left behind.
 */
