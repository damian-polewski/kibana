...
/**
 * Pins the field count of a synth data stream (25 fields as Elasticsearch counts
 * them, including parent objects and multi-fields) so the
 * "field limit exceeded" root-cause assertions stay deterministic. Callers pair
 * it with `mapping.total_fields.limit` set to just above that count.
 *
